...
#define  ECDC_KEYEX_EN                               ((uint16_t)0x0001)
#define  ECDC_NORMAL_EN                              ((uint16_t)0x0002)
#define  ECDC_MODE_SEL                               ((uint16_t)0x0008)

#define  ECDC_CLKDIV_MASK                            ((uint16_t)0x0070)

#define  ECDC_WRSRAM_EN                              ((uint16_t)0x0080)
#define  ECDC_ALGRM_MOD                              ((uint16_t)0x0100)
#define  ECDC_CIPHER_MOD                             ((uint16_t)0x0200)

#define  ECDC_KLEN_MASK                              ((uint16_t)0x0C00)

#define  ECDC_DAT_MOD                                ((uint16_t)0x2000)

/*******************  Bit definition for ECDC_INT_EN register  *******************/
#define  ECDC_IE_EKDONE                              ((uint8_t)0x01)
#define  ECDC_IE_SINGLE                              ((uint8_t)0x02)
#define  ECDC_IE_WRSRAM                              ((uint8_t)0x04)

/*******************  Bit definition for ECDC_CTRL2 register  *******************/
#define  ECDC_CLOCK_SELECT                           ((uint8_t)0x01)
#define  ECDC_ECDC_SM4_CLOCK_EN                      ((uint8_t)0x02)

/*******************  Bit definition for ECDC_INT_FG register  *******************/
#define  ECDC_IF_EKDONE                              ((uint8_t)0x01)
#define  ECDC_IF_SINGLE                              ((uint8_t)0x02)
#define  ECDC_IF_WRSRAM                              ((uint8_t)0x04)
